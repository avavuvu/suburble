...
<footer class="max-w-[900px] mx-auto min-h-48 p-4">
    <div class="flex gap-2 justify-center align-middle items-center bg-gray border rounded p-2 w-fit mx-auto">
        <img 
        ...
        <ul class="flex flex-col gap-2 justify-evenly align-middle">
            ...
            <a href="/melbourne" class="bg-white border rounded p-2 cursor-pointer">
                What counts as 'Melbourne'?
            </a>
            <a href="/donate" class="bg-white border rounded p-2 cursor-pointer">
                Donate
            </a>
        </ul>
